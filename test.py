                    ...
                    if pi.shape[0]:
                        ...
                        for j in (ious > iouv[0]).nonzero():
                            ...
                            if d not in detected:
                                ...
                                if len(detected) == nl:  # 已位于图像中的所有目标
                                    break
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='D:\pyfile\yolo\yolo基础1\dataft\ft.data.txt', help='*.data path')
    parser.add_argument('--weights', type=str, default='D:\pyfile\yolo\yolo基础1\weights\yolov3-tiny.conv.15', help='weights path')
